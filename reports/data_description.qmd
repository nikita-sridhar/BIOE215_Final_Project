...
This paper describes how different taxa respond to different restoration actions, and the time frames at which they respond. There are two restoration actions implemented in various combinations:
...
We will use the columns Family

SA_implementation, Trans_implementation to describe the taxa and restoration actions, and we will use the columns
